                    ...
                    <Col md={8}>
                        ...
                        <CardBody>
                            <Row>
                                ...
                                <Col sm={8} className="value address" data-delegator-address={this.props.validator.delegator_address}><Link to="#" className="text-monospace">{this.props.validator.delegator_address}</Link></Col>
