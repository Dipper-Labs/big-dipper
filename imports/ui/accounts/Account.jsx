...
export default class AccountDetails extends Component{
    ...
    render(){
        ...
        if (this.state.loading){
            ...
            return <div id="account">
                <Helmet>
                    <title>Account Details of {this.state.address} on Dipper Hub | The Big Dipper</title>
                    <meta name="description" content={"Account Details of "+this.state.address+" on Dipper Hub"} />
                </Helmet>
                <Row>
